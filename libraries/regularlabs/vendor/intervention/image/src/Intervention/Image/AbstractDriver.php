...
abstract class AbstractDriver
{
    ...
    private function getCommandClassName($name)
    {
        ...
        $classnameLocal = \sprintf('\\RegularLabs\Scoped\\Intervention\\Image\\%s\\Commands\\%sCommand', $drivername, \ucfirst($name));
        $classnameGlobal = \sprintf('\\RegularLabs\Scoped\\Intervention\\Image\\Commands\\%sCommand', \ucfirst($name));
