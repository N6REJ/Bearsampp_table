...
use Closure;
use RegularLabs\Scoped\Intervention\Image\Exception\MissingDependencyException;
...
class ImageManager
{
    ...
    {
        if (\class_exists('RegularLabs\\Scoped\\Intervention\\Image\\ImageCache')) {
            // create imagecache
    ...
    private function createDriver()
    {
        if (\is_string($this->config['driver'])) {
            ...
            $driverclass = \sprintf('RegularLabs\Scoped\\Intervention\\Image\\%s\\Driver', $drivername);
