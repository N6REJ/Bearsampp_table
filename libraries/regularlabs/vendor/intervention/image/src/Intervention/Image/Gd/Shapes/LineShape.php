...
namespace RegularLabs\Scoped\Intervention\Image\Gd\Shapes;
...
class LineShape extends AbstractShape
{
    ...
    {
        throw new \RegularLabs\Scoped\Intervention\Image\Exception\NotSupportedException("Line width is not supported by GD driver.");
    }
    /**
