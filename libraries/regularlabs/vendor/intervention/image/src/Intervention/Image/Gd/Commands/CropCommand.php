...
use RegularLabs\Scoped\Intervention\Image\Point;
...
class CropCommand extends ResizeCommand
{
    ...
    public function execute($image)
    {
        ...
        if (\is_null($width) || \is_null($height)) {
            throw new \RegularLabs\Scoped\Intervention\Image\Exception\InvalidArgumentException("Width and height of cutout needs to be defined.");
        }
