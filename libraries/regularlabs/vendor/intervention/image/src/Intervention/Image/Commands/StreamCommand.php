...
class StreamCommand extends AbstractCommand
{
    ...
    {
        if (\class_exists(\RegularLabs\Scoped\GuzzleHttp\Psr7\Utils::class)) {
            return \RegularLabs\Scoped\GuzzleHttp\Psr7\Utils::streamFor($data);
            // guzzlehttp/psr7 >= 2.0
        }
        return \RegularLabs\Scoped\GuzzleHttp\Psr7\stream_for($data);
        // guzzlehttp/psr7 < 2.0
    }
}
