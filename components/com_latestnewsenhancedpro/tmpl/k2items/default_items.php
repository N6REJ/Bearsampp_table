...
// 			}
	...
	<?php
		...
		if ($this->show_image || $this->show_calendar) {
	...
	<?php $info_block_over_head = Helper::getInfoBlock($details, $this->params, $this->item, null, 'com_k2'); ?>

	<?php $details = Helper::getDetails($this->params, 'before_title_', 'information_blocks', $this->isleading); ?>
	<?php $info_block_before_title = Helper::getInfoBlock($details, $this->params, $this->item, null, 'com_k2'); ?>

	<?php $details = Helper::getDetails($this->params, 'before_', 'information_blocks', $this->isleading); ?>
	<?php $info_block_before = Helper::getInfoBlock($details, $this->params, $this->item, null, 'com_k2'); ?>

	<?php $details = Helper::getDetails($this->params, 'after_', 'information_blocks', $this->isleading); ?>
	<?php $info_block_after = Helper::getInfoBlock($details, $this->params, $this->item, null, 'com_k2'); ?>
				...
				<div class="newsinfo">
					...
					<?php if ($this->item->title) : ?>
						...
						<?php if (isset($this->item->link_edit)) : ?>
							...
							<?php else : ?>
								<?php $attribs = 'toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width='.$this->popup_width.',height='.$this->popup_height; ?>
								<a href="<?php echo $this->item->link_edit; ?>" class="edit hasTooltip" title="<?php echo Text::_('JGLOBAL_EDIT'); ?>" onclick="window.open(this.href, 'targetWindow', '<?php echo $attribs; ?>'); return false;"><i class="SYWicon-create"></i></a>
							<?php endif; ?>
						<?php endif; ?>
