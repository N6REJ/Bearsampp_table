...
<div class="lnep_list<?php echo $this->pageclass_sfx ? ' '.$this->pageclass_sfx : ''; ?><?php echo $this->isMobile ? ' mobile' : ''; ?>">
	...
	<?php if ($this->show_print) : ?>
		<?php
			...
			$data = array('view' => 'k2items', 'style' => $this->actions_style, 'classes' => $this->actions_classes, 'layout' => 'list', 'print' => $this->print, 'show_print' => $this->show_print);
	...
	<form action="<?php echo Route::_('index.php?option=com_latestnewsenhancedpro&view=k2items&layout=list'); ?>" method="post" name="adminForm" id="adminForm">
