...
$title = isset($displayData['title']) ? $displayData['title'] : Text::_('COM_LATESTNEWSENHANCEDPRO_MODAL_TITLE');
	...
	<div id="<?php echo $selector; ?>" class="puremodal" role="dialog" aria-hidden="true">
		<div class="puremodal-content" aria-modal="true" aria-labelledby="<?php echo $selector; ?>Label">
			...
			<div class="puremodal-footer">
            	<button class="puremodal-close" aria-hidden="true"><?php echo Text::_('COM_LATESTNEWSENHANCEDPRO_CLOSE'); ?></button>
            </div>
		</div>
	</div>
<?php endif; ?>
<?php if ($bootstrap_version == 2) : ?>
	<div id="<?php echo $selector; ?>" data-backdrop="false" data-keyboard="true" data-remote="true" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="<?php echo $selector; ?>Label" aria-hidden="true">
    	...
    	<div class="modal-footer">
    		<button class="btn" data-dismiss="modal" aria-hidden="true"><?php echo Text::_('COM_LATESTNEWSENHANCEDPRO_CLOSE'); ?></button>
    	</div>
    </div>
<?php endif; ?>
<?php if ($bootstrap_version > 2) : ?>
    		...
    		<div class="modal-content">
            	<div class="modal-header">
            		<?php if ($bootstrap_version == 3) : ?>
            			<button type="button" class="close" data-dismiss="modal" aria-label="<?php echo Text::_('COM_LATESTNEWSENHANCEDPRO_CLOSE'); ?>"><span aria-hidden="true">&times;</span></button>
            		...
            		<?php if ($bootstrap_version == 5) : ?>
            			<h5 id="<?php echo $selector; ?>Label" class="modal-title"><?php echo $title; ?></h5>
            			<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo Text::_('COM_LATESTNEWSENHANCEDPRO_CLOSE'); ?>"></button>
            		<?php endif; ?>
            	</div>
            	<div class="modal-body">
            		<iframe class="iframe" height="<?php echo $height; ?>" style="display: block; width: 100%; border: 0; max-height: none; overflow: auto"></iframe>
            	...
            	<div class="modal-footer">
            		<button class="btn btn-secondary" data-<?php echo ($bootstrap_version >= 5 ? 'bs-' : '') ?>dismiss="modal" aria-hidden="true"><?php echo Text::_('COM_LATESTNEWSENHANCEDPRO_CLOSE'); ?></button>
            	</div>
    		</div>
    	</div>
    </div>
