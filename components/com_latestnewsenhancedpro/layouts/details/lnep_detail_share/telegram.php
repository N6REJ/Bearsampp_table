...
if (SYWUtilities::isMobile()) {
	echo '<a class="hasTooltip inline_svg telegram' . $classes . '" href="tg://msg_url?url=' . urlencode($root_path . $url) . '&amp;text=' . urlencode($title) . '" rel="nofollow" data-share-network="telegram" aria-label="' . Text::sprintf("COM_LATESTNEWSENHANCEDPRO_SHAREWITH", "Telegram") . '" title="' . Text::sprintf("COM_LATESTNEWSENHANCEDPRO_SHAREWITH", "Telegram") . '">';
} else {
	echo '<a class="hasTooltip inline_svg telegram' . $classes . '" href="https://telegram.me/share/url?url=' . urlencode($root_path . $url) . '&amp;text=' . urlencode($title) . '" rel="nofollow" data-share-network="telegram" aria-label="' . Text::sprintf("COM_LATESTNEWSENHANCEDPRO_SHAREWITH", "Telegram") . '" title="' . Text::sprintf("COM_LATESTNEWSENHANCEDPRO_SHAREWITH", "Telegram") . '" target="_blank">';
}
