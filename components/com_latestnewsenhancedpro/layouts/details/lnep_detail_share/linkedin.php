...
echo '<a class="hasTooltip inline_svg linkedin' . $classes . '" href="https://www.linkedin.com/shareArticle?mini=true&amp;url=' . urlencode($root_path . $url) . '&amp;title=' . urlencode($title) . '" aria-label="' . Text::sprintf("COM_LATESTNEWSENHANCEDPRO_SHAREWITH", "LinkedIn") . '" title="' . Text::sprintf("COM_LATESTNEWSENHANCEDPRO_SHAREWITH", "LinkedIn") . '" target="_blank">';
