...
$additional_class = '';
if (empty($item->date)) { // should always be null or have a date, so this code won't ever be called
	$additional_class = ' notime';
}

echo '<span class="detail detail_time'.$additional_class.$extraclasses.'">';
...
if ($item->date) {
	echo '<span class="detail_data">'.HTMLHelper::_('date', $item->date, $params->get('t_format', 'H:i')).'</span>';
} else {
