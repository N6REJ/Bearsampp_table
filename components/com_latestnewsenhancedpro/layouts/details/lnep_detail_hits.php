...
$icon = empty($icon) ? 'SYWicon-eye': $icon;
...
echo '<span class="detail detail_hits' . $extraclasses . '">';
...
echo '<span class="detail_data">'.Text::sprintf('COM_LATESTNEWSENHANCEDPRO_HITS', $item->hits).'</span>';
