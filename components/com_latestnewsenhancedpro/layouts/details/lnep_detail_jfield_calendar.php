...
echo '<span class="detail detail_jfield_'.$field_type.' detail_jfield_'.$field_id.$additional_class.$extraclasses.'">';
...
if ($field_data) {
	echo '<span class="detail_data">'.HTMLHelper::_('date', $field_data, $params->get('d_format', 'd F Y')).'</span>';
} else {
