...
if (isset($item->contact_link) && !empty($item->contact_link) && $item_params->get('link_author') && !Factory::getApplication()->input->getBool('print')) {
    // 'contact_link' comes from contact plugin
    echo HTMLHelper::_('link', $item->contact_link, $author);
} else {
    echo $author;
}
