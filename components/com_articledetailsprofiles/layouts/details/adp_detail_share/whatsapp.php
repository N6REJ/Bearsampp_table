...
if (SYWUtilities::isMobile()) {
	echo '<a class="hasTooltip inline_svg whatsapp' . $classes . '" href="whatsapp://send?text=' . urlencode($root_path . $url) . '" data-share-network="whatsapp" aria-label="' . Text::sprintf("PLG_CONTENT_ARTICLEDETAILS_SHAREWITH", "WhatsApp").'" title="' . Text::sprintf("PLG_CONTENT_ARTICLEDETAILS_SHAREWITH", "WhatsApp").'">';
} else {
	echo '<a class="hasTooltip inline_svg whatsapp' . $classes . '" href="https://wa.me/?text=' . urlencode($root_path . $url) . '" rel="nofollow" data-share-network="whatsapp" aria-label="' . Text::sprintf("PLG_CONTENT_ARTICLEDETAILS_SHAREWITH", "WhatsApp").'" title="' . Text::sprintf("PLG_CONTENT_ARTICLEDETAILS_SHAREWITH", "WhatsApp").'" target="_blank" >';
}
