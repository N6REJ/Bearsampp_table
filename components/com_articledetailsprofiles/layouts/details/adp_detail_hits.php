...
$label = empty($label) ? Text::_('PLG_CONTENT_ARTICLEDETAILS_PREPEND_HITS') : $label;
...
echo '<span class="detail_data">' . Text::sprintf('PLG_CONTENT_ARTICLEDETAILS_HITS', $item->hits) . '</span>';
