...
.articledetails {
	...
	.articledetails .info .details {
		...
		.articledetails .info .details .detail_rating .detail_data [class^="SYWicon-"],
		.articledetails .info .details .detail_rating .detail_data [class*=" icon-"],
		.articledetails .info .details .detail_rating .detail_data [class^="icon-"],
		.articledetails .info .details .detail_rating .detail_data [class*=" fa-"],
		.articledetails .info .details .detail_rating .detail_data [class^="fa-"] {
			font-size: 1.2em;
			color: #000;
		}
		...
		.articledetails .info .details .detail_social .detail_data [class^="SYWicon-"],
		.articledetails .info .details .detail_social .detail_data [class*=" icon-"],
		.articledetails .info .details .detail_social .detail_data [class^="icon-"],
		.articledetails .info .details .detail_social .detail_data [class*=" fa-"],
		.articledetails .info .details .detail_social .detail_data [class^="fa-"] {
			font-size: 1.2em;
			color: #000;
		}
