...
<div id="container_base1_modules" class="module_block border_block <?php if($this->params->get('top2_parallax') == "1") {echo 'jarallax';} ?>">
...
<div id="container_base2_modules" class="module_block border_block <?php if($this->params->get('top2_parallax') == "1") {echo 'jarallax';} ?>">
	<div class="wrapper960">
		<div id="base-2">
