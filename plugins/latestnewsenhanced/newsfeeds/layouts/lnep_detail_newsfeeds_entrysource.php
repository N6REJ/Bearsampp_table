...
echo '<span class="detail detail_newsfeeds_entrysource' . $extraclasses . '">'; // convention: detail_[information detail type]
...
if ($item->entrysource['url']) {
	echo '<span class="detail_data"><a href="' . $item->entrysource['url'] . '" target="_blank">' . $item->entrysource['title'] . '</a></span>';
} else {
	echo '<span class="detail_data">' . $item->entrysource['title'] . '</span>';
}
