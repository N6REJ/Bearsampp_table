 ...
 */
class PlgContentArticleDetailsProfilesInstallerScript
{
    /**
	...
	{
	    Factory::getApplication()->enqueueMessage(Text::sprintf('PKG_ARTICLEDETAILSPROFILES_INSTALLED', Text::_('PKG_ARTICLEDETAILSPROFILES_PLG_CONTENT_ARTICLEDETAILSPROFILES')), 'message');
	}
	...
	{
	    //Factory::getApplication()->enqueueMessage(Text::sprintf('PKG_ARTICLEDETAILSPROFILES_UNINSTALLED', Text::_('PKG_ARTICLEDETAILSPROFILES_PLG_CONTENT_ARTICLEDETAILSPROFILES')), 'message');
	}
	...
	{
	    Factory::getApplication()->enqueueMessage(Text::sprintf('PKG_ARTICLEDETAILSPROFILES_UPDATED', Text::_('PKG_ARTICLEDETAILSPROFILES_PLG_CONTENT_ARTICLEDETAILSPROFILES')), 'message');
	}
	...
	public function postflight($action, $installer)
	{
	    ...
	    // the old folders have been removed on update !!!
// 	    if (Folder::exists(JPATH_SITE . '/plugins/content/articledetailsprofiles/images')) {
	        
// 	        $this->deleteFiles[] = '/plugins/content/articledetailsprofiles/headerfilesmaster.php';
	        
// 	        $this->deleteFolders[] = '/plugins/content/articledetailsprofiles/fields';
// 	        $this->deleteFolders[] = '/plugins/content/articledetailsprofiles/helpers';
// 	        $this->deleteFolders[] = '/plugins/content/articledetailsprofiles/images';
	        //$this->deleteFolders[] = '/plugins/content/articledetailsprofiles/styles'; // may contain handmade calendars, removed on update
