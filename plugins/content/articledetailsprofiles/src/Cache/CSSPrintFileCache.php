...
// 		}
		...
		include JPATH_ROOT . '/media/plg_content_articledetailsprofiles/styles/print.css.php';
		if ($calendar) {
			if (File::exists(JPATH_ROOT . '/media/plg_content_articledetailsprofiles/styles/calendars/' . $calendar . '/print.css.php')) {
				include JPATH_ROOT . '/media/plg_content_articledetailsprofiles/styles/calendars/' . $calendar . '/print.css.php';
			}
		}
