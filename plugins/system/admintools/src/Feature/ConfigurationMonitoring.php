...
class ConfigurationMonitoring extends Base
{
	...
	public function onAfterInitialise(): void
	{
		...
		{
			$block |= in_array($task, ['config.save.application.apply', 'config.save.application.save', 'application.apply', 'application.save']);
		}

		if ($this->enabledComponents)
		{
			$block |= in_array($task, ['config.save.component.apply', 'config.save.component.save', 'component.apply', 'component.save']);
		}
