...
class NonstandardcustomfieldtypesField extends GroupedlistField
{
	...
	protected function getGroups()
	{
		...
		if (Folder::exists(JPATH_ADMINISTRATOR . '/components/com_fields') && ComponentHelper::isEnabled('com_fields') && ComponentHelper::getParams('com_content')->get('custom_fields_enable', '1')) {
			...
			$group_name = Text::_('COM_LATESTNEWSENHANCEDPRO_VALUE_STANDARD');
			$groups[$group_name] = array();

			//$options[] = HTMLHelper::_('select.optgroup', Text::_('COM_LATESTNEWSENHANCEDPRO_VALUE_STANDARD'));
			...
			$group_name = Text::_('COM_LATESTNEWSENHANCEDPRO_VALUE_NONSTANDARD');
			$groups[$group_name] = array();

			//$options[] = HTMLHelper::_('select.optgroup', Text::_('COM_LATESTNEWSENHANCEDPRO_VALUE_NONSTANDARD'));
