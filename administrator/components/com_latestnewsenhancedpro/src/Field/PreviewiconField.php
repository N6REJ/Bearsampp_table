			...
			document.addEventListener("readystatechange", function(event) {
				if (event.target.readyState == "complete") {
					...
					function resize_font() {
						let head_width = document.getElementById("jform_params_head_w").value == "" ? 80 : parseInt(document.getElementById("jform_params_head_w").value);
						let head_height = document.getElementById("jform_params_head_h").value == "" ? 80 : parseInt(document.getElementById("jform_params_head_h").value);
					...
					let preview_width = document.getElementById("jform_params_head_w").value == "" ? 80 : parseInt(document.getElementById("jform_params_head_w").value);
					let preview_height = document.getElementById("jform_params_head_h").value == "" ? 80 : parseInt(document.getElementById("jform_params_head_h").value);
					...
					document.getElementById("jform_params_border_c_icon").addEventListener("change", function(event) {
						if (event.target.value != "") {
