...
namespace SYW\Component\LatestNewsEnhancedPro\Administrator\View\Info;
...
/**
 * Latest News Enhanced Pro Info View
 */
class HtmlView extends BaseHtmlView
{
	...
	function display($tpl = null)
	{
		...
		$this->extension_version = strval(simplexml_load_file(JPATH_ADMINISTRATOR . '/components/com_latestnewsenhancedpro/latestnewsenhancedpro.xml')->version);
	...
	protected function addToolbar()
	{
		...
		ToolbarHelper::title(Text::_( 'COM_LATESTNEWSENHANCEDPRO_INFO' ), 'none SYWicon-info');

		if (Factory::getUser()->authorise('core.admin', 'com_latestnewsenhancedpro')) {
		    $toolbar->preferences('com_latestnewsenhancedpro');
		}

		$toolbar->help(null, false, 'https://simplifyyourweb.com/documentation/latest-news');
	}
}
?>
