...
class Submission extends SmartTag
{
	...
	{
		return isset($this->data['submission']->state) && $this->data['submission']->state === 1 ? Text::_('COM_CONVERTFORMS_SUBMISSION_CONFIRMED') : Text::_('COM_CONVERTFORMS_SUBMISSION_UNCONFIRMED');
	}
