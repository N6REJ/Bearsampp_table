...
HTMLHelper::_('script', 'com_convertforms/hcaptcha.js', ['version' => 'auto', 'relative' => true], ['defer' => 'defer']);

// Load hCAPTCHA API JS
HTMLHelper::_('script', 'https://hcaptcha.com/1/api.js?onload=ConvertFormsInitHCaptcha&render=explicit&hl=' . Factory::getLanguage()->getTag(), [], ['defer' => 'defer']);
